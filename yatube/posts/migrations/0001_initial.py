# Generated by Django 2.2.16 on 2022-02-04 19:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Введите название группы', max_length=200, verbose_name='Название группы сообщений')),
                ('slug', models.SlugField(help_text='Введите слаг группы', unique=True, verbose_name='Слаг группы сообщений')),
                ('description', models.TextField(help_text='Введите описание группы сообщений', verbose_name='Описание группы сообщений')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
